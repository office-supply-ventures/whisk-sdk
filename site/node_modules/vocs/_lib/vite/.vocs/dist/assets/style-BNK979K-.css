...
:root {
  ...
  --vocs-fontFamily_default: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;
  --vocs-fontFamily_mono: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;
  ...
  --vocs-content_width: calc(70ch + (var(--vocs-content_horizontalPadding) * 2));
...
@media screen and (max-width: 720px) {
  ...
  background-color: var(--vocs_Banner_bannerBackgroundColor, var(--vocs-color_backgroundAccent));
  border-bottom: 1px solid var(--vocs_Banner_bannerBackgroundColor, var(--vocs-color_borderAccent));
  color: var(--vocs_Banner_bannerTextColor, var(--vocs-color_backgroundAccentText));
...
@media screen and (max-width: 1080px) {
  ...
  --vocs_DocsLayout_leftGutterWidth: max(calc((100vw - var(--vocs-content_width)) / 2), var(--vocs-sidebar_width));
}
...
.vocs_DocsLayout_gutterTop {
  align-items: center;
  background-color: color-mix(in srgb, var(--vocs-color_background) 98%, transparent);
...
.vocs_DocsLayout_gutterRight {
  ...
  height: 100vh;
  overflow-y: auto;
  padding: calc(var(--vocs-content_verticalPadding) + var(--vocs-topNav_height) + var(--vocs-space_8)) var(--vocs-space_24) 0 0;
  position: fixed;
  top: var(--vocs_Banner_bannerHeight, 0px);
  right: 0;
...
.vocs_DocsLayout_gutterRight_withSidebar {
  width: calc(100vw - var(--vocs-content_width) - var(--vocs_DocsLayout_leftGutterWidth));
}
.vocs_DocsLayout_outlinePopover {
  display: none;
  overflow-y: auto;
  height: calc(100vh - var(--vocs-topNav_height) - var(--vocs-topNav_curtainHeight));
}
.vocs_DocsLayout_sidebar {
  padding: var(--vocs-space_0) var(--vocs-sidebar_horizontalPadding) var(--vocs-space_24) var(--vocs-sidebar_horizontalPadding);
}
...
@media screen and (min-width: 1081px) {
  .vocs_DocsLayout_content_withTopNav {
    padding-top: calc(var(--vocs-topNav_height) + var(--vocs_Banner_bannerHeight, 0px));
  }
  .vocs_DocsLayout_gutterTop {
    padding-left: calc(var(--vocs_DocsLayout_leftGutterWidth) - var(--vocs-sidebar_width));
...
.vocs_Tabs_trigger {
  ...
  padding: var(--vocs-space_8) var(--vocs-space_8) var(--vocs-space_6) var(--vocs-space_8);
...
.vocs_Tabs .vocs_CodeBlock, undefined .vocs_CodeBlock {
  border: none;
  margin-left: unset;
  margin-right: unset;
}
...
undefined .vocs_CodeBlock pre {
  background-color: color-mix(in srgb, var(--vocs-color_codeBlockBackground) 65%, transparent) !important;
  border: 1px solid var(--vocs-color_codeInlineBorder);
  border-radius: var(--vocs-borderRadius_4);
...
.vocs_CodeBlock .twoslash-error-line, .vocs_CodeBlock .twoslash-tag-line {
  padding: var(--vocs-space_0) var(--vocs-space_22);
}
...
.vocs_CodeBlock [data-line-numbers] > .line:not(.diff.remove + .diff.add)::before {
...
.vocs_CodeBlock .highlighted-word {
  ...
  background-color: var(--vocs-color_codeCharacterHighlightBackground) !important;
...
.vocs_CodeBlock .has-focused > code > .line:not(.focused), .vocs_CodeBlock .has-focused > code > .twoslash-meta-line:not(.focused) {
  opacity: 0.3;
  transition: opacity 0.2s;
}
.vocs_CodeBlock:hover .has-focused .line:not(.focused), .vocs_CodeBlock:hover .has-focused .twoslash-meta-line:not(.focused) {
  opacity: 1;
  transition: opacity 0.2s;
}
@media screen and (max-width: 720px) {
  ...
  .vocs_CodeBlock .line, .vocs_CodeBlock .twoslash-error-line, .vocs_CodeBlock .twoslash-tag-line {
...
.vocs_H2+.vocs_Step_content,.vocs_H3+.vocs_Step_content,.vocs_H4+.vocs_Step_content,.vocs_H5+.vocs_Step_content,.vocs_H6+.vocs_Step_content {
...
@media screen and (max-width: 720px) {
  .vocs_Step_content > .vocs_Tabs, .vocs_Step_content > .vocs_CodeBlock {
...
@media screen and (max-width: 720px) {
  ...
  background-color: var(--vocs-color_background);
  max-width: var(--vocs-content_width);
  padding: var(--vocs-content_verticalPadding) var(--vocs-content_horizontalPadding);
  width: 100%;
...
:root.dark pre.shiki span:not(.line), :root.dark :not(pre.shiki) .line span {
  color: var(--shiki-dark) !important;
}
pre.shiki {
  background-color: var(--vocs-color_codeBlockBackground) !important;
}
.vocs_Content > *:not(:last-child), .vocs_Details > *:not(:last-child) {
  margin-bottom: var(--vocs-space_24);
}
.vocs_Callout > *:not(:last-child), .vocs_Callout > .vocs_Details > *:not(:last-child) {
  margin-bottom: var(--vocs-space_16);
}
.vocs_Content > *:last-child, .vocs_Callout > *:last-child, .vocs_Details > *:last-child {
  margin-bottom: var(--vocs-space_0);
}
...
:root .twoslash-popup-info-hover, :root .twoslash-popup-info {
...
:root.dark .twoslash-popup-info, :root.dark .twoslash-popup-info-hover {
...
.twoslash-popup-info:hover, .twoslash-popup-info-hover:hover {
...
@media screen and (min-width: 1081px) {
  ...
  .vocs_Header .vocs_Heading_slugTarget, .vocs_Step_title .vocs_Heading_slugTarget, .vocs_Header + .vocs_Heading .vocs_Heading_slugTarget {
...
@media screen and (max-width: 1080px) {
  ...
  .vocs_Header .vocs_Heading_slugTarget, .vocs_Header + .vocs_Heading .vocs_Heading_slugTarget {
    top: calc(-1 * calc(var(--vocs-topNav_curtainHeight) + var(--vocs-space_24)));
  }
}.vocs_Blockquote {
  border-left: 2px solid var(--vocs-color_blockquoteBorder);
  padding-left: var(--vocs-space_16);
  margin-bottom: var(--vocs-space_16);
}.vocs_H2+.vocs_List,.vocs_H3+.vocs_List,.vocs_H4+.vocs_List,.vocs_H5+.vocs_List,.vocs_H6+.vocs_List {
  margin-top: calc(var(--vocs-space_8) * -1);
}
...
.vocs_List_ordered .vocs_List_ordered,.vocs_List_unordered .vocs_List_unordered,.vocs_List_ordered .vocs_List_unordered,.vocs_List_unordered .vocs_List_ordered {
  margin-bottom: var(--vocs-space_0);
...
.vocs_H2+.vocs_Paragraph,.vocs_H3+.vocs_Paragraph,.vocs_H4+.vocs_Paragraph,.vocs_H5+.vocs_Paragraph,.vocs_H6+.vocs_Paragraph,.vocs_List+.vocs_Paragraph {
  margin-top: calc(var(--vocs-space_8) * -1);
}
...
.vocs_DesktopSearch_searchCommand {
  ...
  box-shadow: var(--vocs-color_shadow2) 0px 2px 0px 0px;
...
.vocs_SearchDialog_resultSelected .vocs_SearchDialog_title, .vocs_SearchDialog_resultSelected .vocs_SearchDialog_titleIcon {
  color: var(--vocs-color_textAccent);
}
...
.vocs_SearchDialog_title mark, .vocs_SearchDialog_excerpt mark {
...
.vocs_DesktopTopNav_withLogo {
  padding-left: calc(((100% - var(--vocs-content_width)) / 2) + var(--vocs-topNav_horizontalPadding));
}
...
.vocs_NavigationMenu_trigger::after {
  ...
  margin-left: 0.325em;
  width: 0.625em;
  -webkit-mask: var(--vocs_NavigationMenu_chevronDownIcon) no-repeat center / contain;
...
.vocs_NavigationMenu_content {
  ...
  animation: vocs_NavigationMenu_fadeIn 500ms cubic-bezier(0.16, 1, 0.3, 1);
}*, ::before, ::after {
...
.vocs_Footer {
  ...
  max-width: var(--vocs-content_width);
  overflow-x: hidden;
  padding: var(--vocs-space_28) var(--vocs-content_horizontalPadding) var(--vocs-space_48);
}
...
.vocs_MobileTopNav_trigger::after {
  ...
  margin-left: 0.325em;
  width: 0.625em;
  -webkit-mask: var(--vocs_MobileTopNav_chevronDownIcon) no-repeat center / contain;
          mask: var(--vocs_MobileTopNav_chevronDownIcon) no-repeat center / contain;
}
.vocs_MobileTopNav_trigger[data-state="open"]::after {
  -webkit-mask: var(--vocs_MobileTopNav_chevronUpIcon) no-repeat center / contain;
          mask: var(--vocs_MobileTopNav_chevronUpIcon) no-repeat center / contain;
}
.vocs_MobileTopNav_outlineTrigger {
  animation: vocs_MobileTopNav_fadeIn 500ms cubic-bezier(0.16, 1, 0.3, 1);
  align-items: center;
  color: var(--vocs-color_text2);
  display: flex;
  gap: var(--vocs-space_6);
...
.vocs_MobileTopNav_topNavPopover {
  display: none;
  overflow-y: scroll;
  padding: var(--vocs-sidebar_verticalPadding) var(--vocs-sidebar_horizontalPadding);
  max-height: 80vh;
  width: var(--vocs-sidebar_width);
}
@media screen and (max-width: 1080px) {
...
.border-\[\#3c393f\] {
  --tw-border-opacity: 1;
  border-color: rgb(60 57 63 / var(--tw-border-opacity, 1));
}
.border-\[\#6e6ade\] {
  --tw-border-opacity: 1;
  border-color: rgb(110 106 222 / var(--tw-border-opacity, 1));
}
.border-red-500 {
  --tw-border-opacity: 1;
...
.bg-\[\#323035\] {
  --tw-bg-opacity: 1;
  background-color: rgb(50 48 53 / var(--tw-bg-opacity, 1));
}
.bg-\[\#5b5bd6\] {
  --tw-bg-opacity: 1;
  background-color: rgb(91 91 214 / var(--tw-bg-opacity, 1));
}
.stroke-green-400 {
  stroke: #4ade80;
}
...
.text-\[\#A7A7A8\] {
  --tw-text-opacity: 1;
  color: rgb(167 167 168 / var(--tw-text-opacity, 1));
}
.text-blue-200 {
  --tw-text-opacity: 1;
...
.vocs_ListItem:not(:last-child) {
  ...
  align-items: center;
  background-color: color-mix(in srgb, var(--vocs-color_background2) 75%, transparent);
